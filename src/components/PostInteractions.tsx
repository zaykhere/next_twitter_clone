...
const PostInteractions = ({ username, count, isLiked, isReposted, isSaved, postId }:
  {
    ...
    isLiked: boolean; isReposted: boolean; isSaved: boolean, postId: number
  }) => {
  ...
  return (
    <div className='flex items-center justify-between mt-3 text-textGray gap-4 lg:gap-16'>
      <div className="flex flex-1 items-center justify-between gap-3">
        ...
        <form action={rePostAction}>
          <button className="group flex items-center cursor-pointer gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
              <path
